  ...
  return (
    <section className="px-5 pb-24 pt-32 md:px-8 md:pb-32 md:pt-40">
      <div className="mx-auto max-w-7xl">
        <SectionHeading
          eyebrow="Contact"
          title="Tell us what you need built — we’ll bring the full stack."
          description="Web, apps, design, graphics, cloud, AI, or a legacy rebuild. Share the brief below — we’ll reply within one business day."
          className="mb-12"
        />

        <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <GlassCard className="p-6 md:p-9" hover={false}>
            {sent ? (
              <div className="py-16 text-center">
                <p className="font-[family-name:var(--font-display)] text-3xl text-cream">
                  Request received.
                </p>
          ...
          <div className="space-y-4">
            <GlassCard className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 break-all text-cream">{siteConfig.email}</p>
                </div>
              </div>
            </GlassCard>
            <GlassCard className="p-6">
            ...
            <GlassCard className="flex min-h-[180px] flex-col items-center justify-center p-6 text-center sm:min-h-[220px]">

...
/**
 * Desktop: full cinema (3D + parallax stack name + scroll acts).
 * Mobile: clean static hero — no stack rise, stars, film acts, or long pin height.
 */
export function Hero() {
  ...
  return (
    <section
      id="cinematic-film"
      ref={root}
      className={`relative bg-[#141210] ${desktop ? "h-[480vh]" : "h-[100dvh] min-h-[100svh]"}`}
    >
      <div
        className={
          desktop
            ? "sticky top-0 h-[100svh] w-full overflow-hidden"
            : "relative h-full min-h-[100svh] w-full overflow-hidden"
        }
      >
        {/* Desktop-only: rising HASHSTACK + stars + WebGL */}
        {desktop && (
          <>
        ...
        {!desktop && (
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 70% 50% at 50% 38%, rgba(202,138,4,0.14) 0%, transparent 58%), #141210",
            }}
          />
        )}
        ...
        <div className="pointer-events-none absolute inset-0 z-10">
          <div className="film-intro-block absolute inset-0 flex flex-col justify-center px-6 pb-10 pt-28 md:justify-between md:px-12 md:pb-14 md:pt-32">
            ...
            <div className="film-hint mx-auto hidden flex-col items-center gap-2 text-cream/70 md:flex">
